    ...
    public function render()
    {
        ...
        <script>
            ...
            function mwp_wpvivid_check_has_install_claim_item(selector)
            {
                var check_res = false;
                var has_item = false;
                var has_need_claim_item = false;
                jQuery(selector).each(function(){
                    has_item = true;
                    if(jQuery(this).closest('tr').hasClass('need-claim')){
                        has_need_claim_item = true;
                        check_res = true;
                        return false;
                    }
                });
            ...
            if(isset($report) && !empty($report)){
                ...
                foreach ($report as $task_id => $report_option) {
                    if(isset($report_option['task_id']) && !empty($report_option['task_id']))
                    {
                        ...
                        $last_backup .= '<br>';
                        $last_backup .= $report_option['status'];
                        break;
                    }
